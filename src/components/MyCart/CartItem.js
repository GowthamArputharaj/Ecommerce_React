...
import ProductQuantityVarieties from '../MyCart/ProductQuantityVarieties';
      ...
      <div className={classes.product}>
        ...
        >
          <Grid item xs={4} sm={3} md={3} className={classes.gridImage}>
            <Paper component="form" className={classes.productImagePaper}  >
          ...
          <Grid item xs={8} sm={9} md={9} style={{}} className={classes.gridDetails}>
            ...
            <Grid container direction="row" alignItems="center" justifyContent="center"  >
              ...
              <Grid item xs={7} sm={7} md={4} style={{ textAlign: 'right', }} >
        ...
        </Grid>
        {
          (product.available_quantity.length > 1 && this.state.openVariety === true) ? (
            <>
              <div onClick={() => this.handleVarietiesVisibility(false)} className={classes.background_blur}>
              </div>
