...
import { editAddress, unSelectAllAddressPreference } from '../../actions/index.js';
...
const mapStateToProps = (state, props) => ({
  ...
  selectedAddress: state.shop.addresses.filter((address) => address.id === props.edit_address_id),
});
...
class EditAddress extends Component {
  constructor(props) {
    ...
    this.submitEditAddressForm = this.submitEditAddressForm.bind(this);
    ...
    this.state = ({
      ...
      saveForOtherShop: selectedAddress.saveForOtherShop,
      // houseNo: 'L1051',
      // streetLocality: 'F-7',
    });
  }
  ...
  submitEditAddressForm() {
    ...
    var editAddress = {};
    editAddress.id = this.state.id;
    editAddress.name = this.state.fullName;
    editAddress.houseNo = this.state.houseNo;
    editAddress.streetLocality = this.state.streetLocality;
    editAddress.city = this.state.city;
    editAddress.pincode = this.state.pincode;
    editAddress.address_value = `${this.state.houseNo}, ${this.state.streetLocality}, ${this.state.city}, ${this.state.pincode}.`;
    editAddress.isSelected = this.state.isSelected;
    editAddress.saveForOtherShop = this.state.fullsaveForOtherShop;

    this.props.editAddress(editAddress);
          ...
          <div className={classes.Slide}>
            <Grid container className={classes.Form}>
              <Grid item xs={12} md={12}>
                <span className={classes.addEditAddress}>Edit Address</span>
              </Grid>
              <Grid item xs={12} md={12}>
                <InputBase
                ...
                <Grid container alignItems="center" justifyContent="space-between" style={{ marginTop: '1rem', }} >
                  <Grid item xs={8} md={8}>
                    <Button
                      ...
                      onClick={this.submitEditAddressForm}
                    >
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles, stylesReddit)(EditAddress));
